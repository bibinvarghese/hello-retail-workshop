...
./fanout register kinesis --source-arn $RETAIL_STREAM_ARN --id $STAGE  --destination-region $REGION --active true --parallel false --destination-role-arn $1 --destination $2
